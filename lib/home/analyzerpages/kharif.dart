...
class kharifPage extends StatefulWidget {
  const kharifPage({super.key});

  @override
  State<kharifPage> createState() => _kharifPageState();
}

class _kharifPageState extends State<kharifPage> {
