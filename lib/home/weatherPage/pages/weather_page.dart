...
class _WeatherPageState extends State<WeatherPage> {
  ...
  String getWeatherAnimation(String condition) {
    if (condition.contains('clear')) {
      return 'assets/weatherIcons/sunny.json';
    } else if (condition.contains('cloud')) {
      return 'assets/weatherIcons/cloudy.json';
    } else if (condition.contains('rain')) {
      return 'assets/weatherIcons/rainy.json';
    } else if (condition.contains('thunder')) {
      return 'assets/weatherIcons/Thunder.json';
    } else {
      return 'assets/weatherIcons/cloudy.json'; // Default animation
    }
  }
